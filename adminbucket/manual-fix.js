...
const filePath = 'node_modules/@angular-devkit/build-angular/node_modules/webpack-dev-middleware/lib/util.js';
...
if (modified) {
  ...
  console.log('✅ Successfully applied fix to webpack-dev-middleware');
} else {
