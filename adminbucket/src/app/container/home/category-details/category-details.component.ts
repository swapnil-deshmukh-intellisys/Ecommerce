...
export class CategoryDetailsComponent implements OnInit {
  ...
  gettingData() {
    ...
    let url = this.base_path_service.base_path_api + 'category/particularCategory/' + this.id;
  ...
  saveData() {
    this.loader=true;
    let url = this.base_path_service.base_path_api + 'category/updateCategory/' + this.id;
