...
@Component({
  selector: 'app-inner-sub-cat',
  templateUrl: './inner-sub-cat.component.html',
  styleUrls: ['./inner-sub-cat.component.css']
})
export class InnerSubCatComponent implements OnInit {
  Response: any;
  title: any;
  id: any;
  msgs: any = [];
  ...
  gettingData() {
    this.loader = true;
    const url = this.base_path_sr.base_path_api + 'subCategory/innerSubCategoryDropdown/' + this.id;
